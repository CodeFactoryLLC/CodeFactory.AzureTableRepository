...
using CodeFactory.AzureTableRepository.ExplorerCommands.Project.Dialog;
using System;
...
namespace CodeFactory.AzureTableRepository.ExplorerCommands.Project.Logic
{
	/// <summary>
	/// Code factory command for automation of a project when selected from solution explorer.
	/// </summary>
	public class RepositoryManagerCommand : ProjectCommandBase
	{
		private static readonly string commandTitle = "Generate Repository for Azure Table...";
		private static readonly string commandDescription = "Generate Repository Objects for interacting with Azure Storage Tables";

#pragma warning disable CS1998

		/// <inheritdoc />
		public RepositoryManagerCommand(ILogger logger, IVsActions vsActions) : base(logger, vsActions, commandTitle, commandDescription)
		{
			//Intentionally blank
		}
#pragma warning disable CS1998
		...
		public override async Task ExecuteCommandAsync(VsProject result)
		{
			try
			{
				...
				.CreateVsUserControlAsync<RepositoryConfigurationDialog>();
				dialog.Project = result;
